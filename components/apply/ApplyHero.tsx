// components/apply/ApplyHero.tsx
"use client";

import { motion } from "framer-motion";
import { FileText, ArrowDown, Users } from "lucide-react";
import { Button } from "@/components/ui/button";

export function ApplyHero() {
  return (
    <section className='relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-linear-to-br from-slate-50 via-blue-50 to-teal-50 dark:from-slate-950 dark:via-blue-950 dark:to-teal-950 px-4 sm:px-6 lg:px-8 pt-24 pb-16 sm:py-24'>
      {/* Background Elements */}
      ...
      <div className='w-full max-w-6xl mx-auto relative z-10 text-center'>
        <motion.div
          ...
          <motion.p
            ...
            Apply for our youth empowerment programs, women&apos;s skill
            acquisition initiatives, or talent discovery opportunities. Take the
            first step towards transforming your future.
          </motion.p>
          ...
          <motion.div
            ...
            {[
              { number: "1,000+", label: "Beneficiaries" },
              { number: "95%", label: "Success Rate" },
              { number: "3", label: "Program Types" },
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, scale: 0.5 }}
