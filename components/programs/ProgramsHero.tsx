// components/programs/ProgramsHero.tsx
"use client";
...
export function ProgramsHero() {
  return (
    <section className='relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-linear-to-br from-slate-50 via-blue-50 to-teal-50 dark:from-slate-950 dark:via-blue-950 dark:to-teal-950 px-4 sm:px-6 lg:px-8 pt-24 pb-16 lg:py-24'>
      {/* Background Elements */}
      ...
      <div className='w-full max-w-6xl mx-auto relative z-10 text-center'>
        <motion.div
          ...
          <motion.p
            ...
            Our comprehensive empowerment initiatives are designed to create
            lasting change through sustainable programs, skill development, and
            talent discovery in underserved communities.
          </motion.p>
