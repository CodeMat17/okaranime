      ...
      <div className='w-full max-w-6xl mx-auto relative z-10 text-center'>
        <motion.div
          ...
          <motion.p
            ...
            For over 5 years, OKARANIME HERITAGE FOUNDATION has been at the
            forefront of empowering underserved communities through sustainable
            programs, skill development, and talent discovery.
          </motion.p>
        </motion.div>
      </div>
    </section>
