// components/partners/PartnersHero.tsx
"use client";
      ...
      <div className='w-full max-w-6xl mx-auto relative z-10 text-center'>
        <motion.div
          ...
          <motion.p
            ...
            Together, we can create sustainable change. Partner with us to
            empower underserved communities through youth development,
            women&apos;s empowerment, and talent discovery programs.
          </motion.p>
